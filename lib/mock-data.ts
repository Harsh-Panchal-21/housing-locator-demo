...
export const mockProperties: Property[] = [
  ...
  {
    id: '7',
    title: 'Champaign Student Housing',
    ...
    description: 'Modern 1-bedroom near UIUC campus. Great for students and young professionals. High-speed internet included.',
    images: ['/placeholder-apartment-7.jpg'],
    amenities: ['High-Speed Internet', 'Study Lounge', 'Bike Storage', 'Laundry Facilities'],
    accessibilityFeatures: ['Elevator Access'],
    subsidyPrograms: ['Housing Choice Voucher'],
    petPolicy: 'No pets',
    utilities: ['Internet Included', 'Water Included'],
    landlordId: 'l7',
    landlordName: 'Campus Housing Partners',
    landlordPhone: '217-555-0707',
    landlordEmail: 'info@campushousing.com',
    waitlistOpen: true,
    waitlistCount: 18,
    lat: 40.1164,
    lng: -88.2434,
  ...
  {
    id: '8',
    title: 'Joliet Affordable Living',
    address: '432 Jefferson Street',
    city: 'Joliet',
    county: 'Will',
    state: 'IL',
    zip: '60432',
    ...
    squareFeet: 850,
    availableDate: '2026-04-15',
    description: 'Affordable 2-bedroom in downtown Joliet. Near Metra station for easy Chicago commute. Recently updated kitchen.',
    images: ['/placeholder-apartment-8.jpg'],
    amenities: ['Updated Kitchen', 'On-site Parking', 'Laundry Room', 'Near Transit'],
    accessibilityFeatures: ['Ground Floor Unit'],
    subsidyPrograms: ['Section 8', 'Housing Choice Voucher'],
    petPolicy: 'Cats allowed',
    utilities: ['Heat Included'],
    landlordId: 'l8',
    landlordName: 'Downtown Joliet Rentals',
    landlordPhone: '815-555-0808',
    landlordEmail: 'leasing@jolietrentals.com',
    waitlistOpen: false,
    waitlistCount: 0,
    lat: 41.5250,
    lng: -88.0817,
  ...
  {
    id: '9',
    title: 'Naperville Family Townhome',
    address: '789 Oak Brook Lane',
    city: 'Naperville',
    county: 'DuPage',
    state: 'IL',
    zip: '60540',
    ...
    squareFeet: 1500,
    availableDate: '2026-05-01',
    description: 'Beautiful 3-bedroom townhome in excellent school district. Finished basement and private patio. Close to Riverwalk.',
    images: ['/placeholder-apartment-9.jpg'],
    amenities: ['Finished Basement', 'Private Patio', 'Attached Garage', 'Central AC', 'Dishwasher'],
    accessibilityFeatures: [],
    subsidyPrograms: ['LIHTC', 'Housing Choice Voucher'],
    petPolicy: 'Pets welcome with deposit',
    utilities: ['Tenant pays all utilities'],
    landlordId: 'l9',
    landlordName: 'Naperville Property Group',
    landlordPhone: '630-555-0909',
    landlordEmail: 'rentals@napervillepg.com',
    waitlistOpen: true,
    waitlistCount: 22,
    lat: 41.7508,
    lng: -88.1535,
  ...
  {
    id: '10',
    title: 'Decatur Affordable Apartments',
    ...
    squareFeet: 600,
    availableDate: '2026-03-15',
    description: 'Cozy 1-bedroom in quiet Decatur neighborhood. New appliances and fresh paint. Utilities included in rent.',
    images: ['/placeholder-apartment-10.jpg'],
    amenities: ['New Appliances', 'On-site Laundry', 'Parking', 'Storage Unit'],
    accessibilityFeatures: ['Ground Floor Unit'],
    subsidyPrograms: ['Section 8', 'Public Housing'],
    petPolicy: 'Small pets allowed',
    utilities: ['All Utilities Included'],
    landlordId: 'l10',
    landlordName: 'Central IL Housing',
    landlordPhone: '217-555-1010',
    landlordEmail: 'info@centralilhousing.com',
    waitlistOpen: true,
    waitlistCount: 7,
    lat: 39.8403,
    lng: -88.9548,
  ...
  {
    id: '11',
    title: 'Evanston Lakefront Studio',
    address: '1001 Chicago Avenue',
    city: 'Evanston',
    county: 'Cook',
    state: 'IL',
    zip: '60201',
    ...
    squareFeet: 500,
    availableDate: '2026-04-01',
    description: 'Charming studio blocks from Lake Michigan. Northwestern University area. Hardwood floors and updated bathroom.',
    images: ['/placeholder-apartment-11.jpg'],
    amenities: ['Hardwood Floors', 'Lake Views', 'Bike Storage', 'Near CTA'],
    accessibilityFeatures: ['Elevator Access'],
    subsidyPrograms: ['Housing Choice Voucher'],
    petPolicy: 'Cats only',
    utilities: ['Heat Included', 'Water Included'],
    landlordId: 'l11',
    landlordName: 'Lakefront Properties',
    landlordPhone: '847-555-1111',
    landlordEmail: 'leasing@lakefrontprops.com',
    waitlistOpen: false,
    waitlistCount: 0,
    lat: 42.0451,
    lng: -87.6877,
  ...
  {
    id: '12',
    title: 'Quincy Historic District',
    ...
    squareFeet: 900,
    availableDate: '2026-03-20',
    description: 'Charming 2-bedroom in historic Quincy. Original hardwood floors and high ceilings. Walking distance to downtown.',
    images: ['/placeholder-apartment-12.jpg'],
    amenities: ['Historic Character', 'High Ceilings', 'Hardwood Floors', 'Near Downtown'],
    accessibilityFeatures: [],
    subsidyPrograms: ['Section 8', 'HOME Program'],
    petPolicy: 'Pets negotiable',
    utilities: ['Water Included'],
    landlordId: 'l12',
    landlordName: 'Historic Quincy Properties',
    landlordPhone: '217-555-1212',
    landlordEmail: 'info@historicquincy.com',
    waitlistOpen: true,
    waitlistCount: 3,
    lat: 39.9356,
    lng: -91.4099,
